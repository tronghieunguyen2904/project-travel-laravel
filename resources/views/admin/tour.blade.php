                        ...
                        <li class="nav-item active submenu">
                            ...
                            <div class="collapse show" id="tables">
                                <ul class="nav nav-collapse">
                                    ...
                                    <li>
                                        <a href="/admin/order">
                                            <span class="sub-item">Quản lí đơn hóa đơn</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/admin/tour">
                                    ...
                                    <li>
                                        <a href="/admin/order">
                                            <span class="sub-item">Quản lí đơn tin tức</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                                            ...
                                                            <div class="col-md-6 pr-0">
                                                                <div class="form-group form-group-default">
                                                                    ...
                                                                    <select class="form-select"
                                                                        ...
                                                                        style="padding:6px;margin-top:5px;"
                                                                        name="best_seller">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="alert alert-danger">Thêm không thành công. Vui lòng kiểm tra lại dữ liệu</p>
                                        @endif
                                        <div class="table-responsive">
                                            <table id="basic-datatables"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>{{$k}}</td>
                                                        <td>{{$items->name_tour}}</td>
                                                        <td>{{$items->date_go}}</td>
                                                        <td>{{$items->date_back}}</td>
                                                        <td>{{$items->child_price}}</td>
                                                        <td>{{$items->adult_price}}</td>
                                                        <td><img src="/storage/admin/img/{{$items->img_tour}}" alt=""
                                                                id="img_product"></td>
                                                        <td>
                                                            <div id="action">
                                                                <div class="container-remove" data-placement="top"
                                                                    title="Edit" data-toggle="tooltip">
                                                                    <i class="fa fa-edit"></i> <a
                                                                        href="/admin/tour/edit/{{$items->id_tour}}">Sửa</a>
                                                                </div>
                                                                <!-- <form action="/admin/tour/detele/{{$items->id_tour}}" method="post"> -->
                                                                <!-- <button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Remove"> -->
                                                                <form action="/admin/tour/delete/{{$items->id_tour}}"
                                                                    method="post">
                                                                    @csrf
                                                                    ...
                                                                    <div class="container-remove" data-placement="top"
                                                                        ...
                                                                        <i class="fa-solid fa-trash-can"></i><input
                                                                            type="submit" value="Xóa" class="btn-remove"
                                                                            data-toggle="modal"
