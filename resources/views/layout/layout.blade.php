...
<body>
                                ...
                                <ul class="nav nav-collapse">
                                    <li>
                                        <a href="../tables/tables.html">
                                            <span class="sub-item">Loại Tour</span>
                                        </a>
                                    </li>
                                    <li class="active">
                                        <a href="/admin/tour">
                                            <span class="sub-item">Tour du lịch</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                                                ...
                                                <table class="table">
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="/assets/layout/img/flags/id.png"
                                                                        alt="indonesia">
                                                                </div>
                                                            </td>
                                                            <td>Indonesia</td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="/assets/layout/img/flags/us.png"
                                                                        alt="united states">
                                                                </div>
                                                            </td>
                                                            <td>USA</td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="/assets/layout/img/flags/au.png"
                                                                        alt="australia">
                                                                </div>
                                                            </td>
                                                            <td>Australia</td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="/assets/layout/img/flags/ru.png"
                                                                        alt="russia">
                                                                </div>
                                                            </td>
                                                            <td>Russia</td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="/assets/layout/img/flags/cn.png"
                                                                        alt="china">
                                                                </div>
                                                            </td>
                                                            <td>China</td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="/assets/layout/img/flags/br.png"
                                                                        alt="brazil">
                                                                </div>
                                                            </td>
                                                            <td>Brasil</td>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                ...
                                <div class="card-body pb-0">
                                    <div class="d-flex">
                                        <div class="avatar">
                                            <img src="/assets/layout/img/logoproduct.svg" alt="..."
                                                class="avatar-img rounded-circle">
                                        </div>
                                    ...
                                    <div class="d-flex">
                                        <div class="avatar">
                                            <img src="/assets/layout/img/logoproduct3.svg" alt="..."
                                                class="avatar-img rounded-circle">
                                        </div>
                                        <div class="flex-1 pt-1 ml-2">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="card-list">
                                        <div class="item-list">
                                            <div class="avatar">
                                                <img src="/assets/layout/img/jm_denis.jpg" alt="..."
                                                    class="avatar-img rounded-circle">
                                            </div>
                                        ...
                                        <div class="item-list">
                                            <div class="avatar">
                                                <img src="/assets/layout/img/chadengle.jpg" alt="..."
                                                    class="avatar-img rounded-circle">
                                            </div>
                                            <div class="info-user ml-3">
                                        ...
                                        <div class="item-list">
                                            <div class="avatar">
                                                <img src="/assets/layout/img/talha.jpg" alt="..."
                                                    class="avatar-img rounded-circle">
                                            </div>
                                            <div class="info-user ml-3">
                                        ...
                                        <div class="item-list">
                                            <div class="avatar">
                                                <img src="/assets/layout/img/mlane.jpg" alt="..."
                                                    class="avatar-img rounded-circle">
                                            </div>
                                            <div class="info-user ml-3">
    ...
    <!-- Chart JS -->
    <script src="/assets/layout/js/admin/plugin/chart.js/chart.min.js"></script>

    <!-- jQuery Sparkline -->
    <script src="/assets/layout/js/admin/plugin/jquery.sparkline/jquery.sparkline.min.js"></script>

    <!-- Chart Circle -->
    <script src="/assets/layout/js/admin/plugin/chart-circle/circles.min.js"></script>

    <!-- Datatables -->
    <script src="/assets/layout/js/admin/plugin/datatables/datatables.min.js"></script>

    <!-- Bootstrap Notify -->
    <script src="/assets/layout/js/admin/plugin/bootstrap-notify/bootstrap-notify.min.js"></script>

    <!-- jQuery Vector Maps -->
    <script src="/assets/layout/js/admin/plugin/jqvmap/jquery.vmap.min.js"></script>
    <script src="/assets/layout/js/admin/plugin/jqvmap/maps/jquery.vmap.world.js"></script>

    <!-- Sweet Alert -->
    <script src="/assets/layout/js/admin/plugin/sweetalert/sweetalert.min.js"></script>

    <!-- Atlantis JS -->
    <script src="/assets/layout/js/admin/atlantis.min.js"></script>

    <!-- Atlantis DEMO methods, don't include it in your project! -->
    <script src="/assets/layout/js/admin/setting-demo.js"></script>
    <script src="/assets/layout/js/admin/demo.js"></script>
    <script>
    Circles.create({
        id: 'circles-1',
        radius: 45,
